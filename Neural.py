...
styleGan = StyleGAN(discriminator=discriminator_model, generator=generator_model, latent_dim=0, discriminator_extra_steps=4, level_network=level)
...
styleGan.fit(image_training, batch_size=32, steps_per_epoch=32, epochs=100)
